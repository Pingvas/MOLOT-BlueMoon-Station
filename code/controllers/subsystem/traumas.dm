...
/datum/controller/subsystem/traumas/Initialize()
	...
	phobia_objs = list("snakes" = typecacheof(list(/obj/item/rod_of_asclepius)),
					...
					"mimes" = typecacheof(list(/obj/item/modular_computer/pda/mime, /obj/item/clothing/under/rank/civilian/mime, /obj/item/clothing/mask/gas/mime,
						...
						/obj/item/grown/bananapeel/mimanapeel, /obj/item/computer_disk/virus/mime, /obj/item/clothing/shoes/sneakers/mime,
