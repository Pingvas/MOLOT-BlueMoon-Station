...
/obj/item/robot_module/engineering/be_transformed_to(obj/item/robot_module/old_module)
	...
	switch(engi_borg_icon)
		...
		if("Meka") //Krashly Request
			...
			cyborg_icon_override = 'modular_bluemoon/icons/mob/tallrobot.dmi'
			hasrest = TRUE
		if("Assaultron") // SPLURT Addon (Hyper Port)
...
/obj/item/robot_module/security/be_transformed_to(obj/item/robot_module/old_module)
	...
	if(!sec_icons)
		...
		"FMeka Syndie" = image(icon = 'modular_bluemoon/icons/mob/tallrobot.dmi', icon_state = "fmekasyndi"), // Lyoll Request (Skyrat Port) & Добавлен дополнительно в СБ-борги по запросу SmiLeY
...
/obj/item/robot_module/butler/be_transformed_to(obj/item/robot_module/old_module)
	...
	switch(service_robot_icon)
		...
		if("(Janitor) Ratge") // //CassiusRogue request
			...
			cyborg_icon_override = 'modular_bluemoon/icons/mob/ratge.dmi'
			hasrest = TRUE
		if("Assaultron") // SPLURT Addon
