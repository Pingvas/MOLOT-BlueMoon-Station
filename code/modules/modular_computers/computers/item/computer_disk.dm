...
/**
 * Virus disk — can't hold apps, instead does unique actions when sent via messenger.
 */
...
/**
 * Clown virus — makes people's PDA honk.
...
/**
 * Mime virus — makes PDA silent, removing their ringtone.
 */
...
/**
 * Detomatix virus — sends a false message, and blows the PDA up if the target
 * responds to it (or opens their messenger before a timer).
 */
...
/**
 * Frame cartridge — creates and opens a false uplink on someone's PDA.
