		...
		if(SETTINGS_TAB) // Character Settings#
			...
			switch(character_settings_tab)
				...
				//Mutant stuff
					...
					dat += "<span title='Особые грязные взаимодействия: выделения, газы, другое'>Unholy Hard : <a href='?_src_=prefs;preference=unholyhardpref' onclick=\"return confirm('Включить парамерт особо грязного секса? В этом случае вам будут доступны расширенные взаимодействия.');\">[unholyhardpref]</a></span><br>"
