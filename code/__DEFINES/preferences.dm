...
#define SOUND_MENTORHELP			(1<<10)
#define SOUND_FAX					(1<<14)
...
#define TOGGLES_DEFAULT (SOUND_ADMINHELP|SOUND_MIDI|SOUND_AMBIENCE|SOUND_LOBBY|MEMBER_PUBLIC|INTENT_STYLE|MIDROUND_ANTAG|SOUND_INSTRUMENTS|SOUND_JUKEBOXES|SOUND_PERSONAL_JUKEBOXES|SOUND_SHIP_AMBIENCE|SOUND_PRAYERS|SOUND_ANNOUNCEMENTS|SOUND_BARK|SOUND_EMOTE|SOUND_MENTORHELP|SOUND_FAX)
