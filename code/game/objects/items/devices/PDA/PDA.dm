...
/mob/living/silicon/ai/proc/cmd_show_message_log(mob/user)
	...
	if(!isnull(aiPDA))
		var/dpi_style = user.client?.dpi_style_tag() || ""
		var/HTML = "<html><head><meta http-equiv='Content-Type' content='text/html; charset=utf-8'><title>AI PDA Message Log</title>[dpi_style]</head><body>[aiPDA.tnote]</body></html>"
