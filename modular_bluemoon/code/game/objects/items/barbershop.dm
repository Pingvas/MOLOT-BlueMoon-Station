/obj/item/blackcomb
	...
	icon = 'modular_bluemoon/icons/obj/barbershop.dmi'
...
/obj/item/razor/scissors/shave(mob/living/carbon/human/H, location = BODY_ZONE_PRECISE_MOUTH)
	...
	H.update_hair()
	playsound(loc, 'modular_bluemoon/sound/scissors.ogg', 20, 1)
...
/obj/item/razor/straight_razor/shave(mob/living/carbon/human/H, location = BODY_ZONE_PRECISE_MOUTH)
	...
	H.update_hair()
	playsound(loc, 'modular_bluemoon/sound/straight_razor.ogg', 20, 1)
...
/obj/item/dyespray/hairspray/dye(mob/target)
	...
	if(!do_after(usr, 30, target = human_target))
		return
	playsound(src, 'modular_bluemoon/sound/sprayer.ogg', 5, TRUE, 5)
