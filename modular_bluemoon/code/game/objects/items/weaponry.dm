...
/obj/item/claymore/cerberus
	...
	item_state = "claymore"
	lefthand_file = 'modular_bluemoon/icons/mob/inhands/weapons/lefthand.dmi'
	righthand_file = 'modular_bluemoon/icons/mob/inhands/weapons/righthand.dmi'
	force = 30
...
/obj/item/projectile/energy/electrode/security/hos/bolestrel
	icon = 'modular_bluemoon/icons/obj/projectiles.dmi'
	icon_state = "cbbolt"
...
/obj/item/nullrod/hadar_red
	...
	icon = 'modular_bluemoon/icons/obj/weapons/tall.dmi'
	lefthand_file = 'modular_bluemoon/icons/mob/inhands/weapons/tall/lefthand.dmi'
	righthand_file = 'modular_bluemoon/icons/mob/inhands/weapons/tall/righthand.dmi'
	mob_overlay_icon = 'modular_bluemoon/icons/mob/item_back/tall.dmi'
...
/obj/item/nullrod/hadar_red/add_blood_overlay() // Меч слишком большой для старой иконки крови на предметах, моя новая иконка фиксит красную половину меча.
	...
	if(initial(icon) && initial(icon_state))
		...
		blood_splatter_icon.Blend(icon('modular_bluemoon/icons/obj/weapons/tall.dmi', "item_blood"), ICON_MULTIPLY)
...
/obj/item/gun/ballistic/automatic/ak12
	...
	burst_size = 3
	fire_delay = 2
	fire_sound = 'modular_bluemoon/sound/ak12_fire.ogg'
