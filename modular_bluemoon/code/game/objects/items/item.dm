/obj/item/hand_mirror
	...
	icon = 'modular_bluemoon/icons/obj/hand_mirror.dmi'
	icon_state = "mirror"
...
/obj/structure/sign/flag/skull
	...
	icon = 'modular_bluemoon/icons/obj/skull_flag.dmi'
	icon_state = "full"
...
/obj/structure/closet/crate/coffin/attacked_by(obj/item/sign/flag/I, mob/living/user)
	...
	if(I.flag_type == "inteq")
		icon = 'modular_bluemoon/icons/obj/inteq_flag.dmi'
		icon_state = "grob_full"
		locked = TRUE
		qdel(I)
...
/obj/item/soap/inteq
	...
	cleanspeed = 10
	icon = 'modular_bluemoon/icons/obj/inteq_soap.dmi'
	lefthand_file = 'modular_bluemoon/icons/mob/inhands/obj/lefthand.dmi'
	righthand_file = 'modular_bluemoon/icons/mob/inhands/obj/righthand.dmi'

/obj/item/reagent_containers/food/snacks/intecookies
	name = "InteCookies"
	desc = "Песочное печенье, каждое из которых в форме маленьких щитов."
	icon = 'modular_bluemoon/icons/obj/inteq_snacks.dmi'
...
/obj/item/storage/fancy/cigarettes/cigpack_inteq
	...
	icon = 'modular_bluemoon/icons/obj/inteq_cigarettes.dmi'
	icon_state = "inteq"
...
/obj/item/toy/mecha/hermes
	name = "toy Hermes"
	icon = 'modular_bluemoon/icons/obj/toys.dmi'
...
/obj/item/paper/book_alch
	...
	icon = 'modular_bluemoon/icons/obj/alchemist.dmi'
