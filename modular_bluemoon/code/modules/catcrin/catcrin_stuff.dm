...
/obj/item/clothing/head/helmet/sec/mark45
	...
	icon = 'modular_bluemoon/icons/mob/icons/mark45.dmi'
	mob_overlay_icon = 'modular_bluemoon/icons/mob/clothing/mark45.dmi'
	icon_state = "mark45_helmet"
	item_state = "mark45_helmet"
	lefthand_file = 'modular_bluemoon/icons/mob/inhands/mark45_lefthand.dmi'
	righthand_file = 'modular_bluemoon/icons/mob/inhands/mark45_righthand.dmi'
	unique_reskin = null
...
/obj/item/clothing/head/helmet/brigdoc/mark45_medic_l
	...
	icon = 'modular_bluemoon/icons/mob/icons/mark45medic.dmi'
	mob_overlay_icon = 'modular_bluemoon/icons/mob/clothing/mark45medic.dmi'
...
/obj/item/clothing/head/helmet/space/hardsuit/security/mark46_sec
	...
	icon = 'modular_bluemoon/icons/mob/icons/mark45.dmi'
	mob_overlay_icon = 'modular_bluemoon/icons/mob/clothing/mark45.dmi'
	anthro_mob_worn_overlay = 'modular_bluemoon/icons/mob/clothing/mark45.dmi'
...
/obj/item/clothing/neck/tie/maskchalat
	...
	icon = 'modular_bluemoon/icons/mob/icons/neck.dmi'
...
/obj/item/gun/energy/e_gun/hos/karabiner_m13
	...
	icon = 'modular_bluemoon/icons/weapons/icons/aa_multiphasecarabinb.dmi'
	lefthand_file = 'modular_bluemoon/icons/weapons/hands/guns_left.dmi'
	righthand_file = 'modular_bluemoon/icons/weapons/hands/guns_right.dmi'
...
/obj/item/ammo_casing/energy/disabler/karabiner_m13
	fire_sound = 'modular_bluemoon/sound/weapons/Karabiner-M13/DisablerOni.ogg'

/obj/item/ammo_casing/energy/laser/hos/karabiner_m13
	fire_sound = 'modular_bluemoon/sound/weapons/Karabiner-M13/LaserOni.ogg'

/obj/item/ammo_casing/energy/ion/hos/karabiner_m13
	fire_sound = 'modular_bluemoon/sound/weapons/Karabiner-M13/IonOni.ogg'

/obj/item/ammo_casing/energy/electrode/hos/karabiner_m13
	fire_sound = 'modular_bluemoon/sound/weapons/Karabiner-M13/TaserOni.ogg'
...
/obj/item/gun/ballistic/shotgun/automatic/combat/frontline
	...
	icon = 'modular_bluemoon/icons/weapons/icons/csfrontline.dmi'
	lefthand_file = 'modular_bluemoon/icons/weapons/hands/guns_left.dmi'
	righthand_file = 'modular_bluemoon/icons/weapons/hands/guns_right.dmi'
	icon_state = "csfrontline"
	item_state = "csfrontline"
	fire_sound = 'modular_bluemoon/sound/weapons/frontlineshot.ogg'
	unique_reskin = null
...
/obj/item/gun/ballistic/shotgun/riot/yernela
	...
	icon = 'modular_bluemoon/icons/weapons/icons/yernela.dmi'
	lefthand_file = 'modular_bluemoon/icons/weapons/hands/guns_left.dmi'
	righthand_file = 'modular_bluemoon/icons/weapons/hands/guns_right.dmi'
	icon_state = "yernela"
	item_state = "yernela"
	fire_sound = 'modular_bluemoon/sound/weapons/yernelashot.ogg'
	unique_reskin = null
...
/obj/item/gun/ballistic/automatic/wt550/gewehr550
	...
	icon = 'modular_bluemoon/icons/weapons/icons/aa_gewehr550.dmi'
	lefthand_file = 'modular_bluemoon/icons/weapons/hands/guns_left.dmi'
	righthand_file = 'modular_bluemoon/icons/weapons/hands/guns_right.dmi'
	icon_state = "gewehr550"
	item_state = "gewehr550"
	fire_sound = 'modular_bluemoon/sound/weapons/G-550shot1.ogg'
	pickup_sound = "modular_bluemoon/sound/weapons/g-550grab.ogg"
	can_suppress = FALSE
	can_bayonet = TRUE
	knife_x_offset = 30
	knife_y_offset = 10
...
/obj/item/gun/energy/laser/hwal2572
	...
	icon_state = "hwal"
	item_state = "hwal"
	icon = 'modular_bluemoon/icons/weapons/icons/hwal.dmi'
	lefthand_file = 'modular_bluemoon/icons/weapons/hands/guns_left.dmi'
	righthand_file = 'modular_bluemoon/icons/weapons/hands/guns_right.dmi'
	ammo_x_offset = 0
	...
	pickup_sound = 'modular_bluemoon/sound/weapons/H-Wal-2572/DisablerGrab.ogg'
	var/last_altfire = 0
...
/obj/item/ammo_casing/energy/disabler/hwal2572
	fire_sound = 'modular_bluemoon/sound/weapons/H-Wal-2572/DisablerOni.ogg'

/obj/item/ammo_casing/energy/electrode/security/hwal2572
	fire_sound = 'modular_bluemoon/sound/weapons/H-Wal-2572/TaserOni.ogg'
...
/obj/item/melee/baton/stunspear
	...
	icon = 'modular_bluemoon/icons/weapons/icons/stunspear.dmi'
	lefthand_file = 'modular_bluemoon/icons/weapons/hands/guns_left.dmi'
	righthand_file = 'modular_bluemoon/icons/weapons/hands/guns_right.dmi'
...
/obj/item/melee/baton/stunspear/switch_status(new_status = FALSE, silent = FALSE)
	if(turned_on != new_status)
		...
		if(!silent)
			playsound(loc, 'modular_bluemoon/sound/weapons/stunspear.ogg', 75, 1, -1)
		if(turned_on)
...
/obj/item/shield/riot/ffshield
	...
	icon = 'modular_bluemoon/icons/weapons/icons/ffshield.dmi'
	lefthand_file = 'modular_bluemoon/icons/weapons/hands/guns_left.dmi'
	righthand_file = 'modular_bluemoon/icons/weapons/hands/guns_right.dmi'
	slot_flags = null
	force = 3
...
/obj/item/shield/riot/ffshield/attack_self(mob/living/user)
	...
	playsound(src.loc, 'modular_bluemoon/sound/weapons/ffshield.ogg', 50, TRUE)
...
/obj/item/gun/ballistic/automatic/pistol/enforcer/bwal2572
	...
	icon = 'modular_bluemoon/icons/weapons/icons/bwal.dmi'
	icon_state = "bwal"
	fire_sound = 'modular_bluemoon/sound/weapons/bwalshot.ogg'
	unique_reskin = null
...
/obj/item/gun/ballistic/automatic/magrifle/magrrinei
	...
	icon = 'modular_bluemoon/icons/weapons/icons/magweapon.dmi'
	lefthand_file = 'modular_bluemoon/icons/weapons/hands/guns_left.dmi'
	righthand_file = 'modular_bluemoon/icons/weapons/hands/guns_right.dmi'
	icon_state = "rinei"
	item_state = "rinei"
	fire_sound = 'modular_bluemoon/sound/weapons/magshot.ogg'
...
/obj/item/kitchen/knife/combat/hopesh
	...
	item_state = "hopesh"
	icon_state = "hopesh"
	icon = 'modular_bluemoon/icons/weapons/icons/hopesh.dmi'
	lefthand_file = 'modular_bluemoon/icons/weapons/hands/guns_left.dmi'
	righthand_file = 'modular_bluemoon/icons/weapons/hands/guns_right.dmi'
	mob_overlay_icon = 'modular_bluemoon/icons/weapons/mob/back.dmi'
	hitsound = 'modular_bluemoon/sound/weapons/hopesh.ogg'
...
/obj/item/clothing/mask/gas/syndicate/cool_version/verb/maskhalt()
	...
	if(frase)
		...
		switch(rand(0,3))
			if(0)
				playsound(src.loc, 'modular_bluemoon/sound/misc/catcrin_halt0.ogg', 100, 1)
			if(1)
				playsound(src.loc, 'modular_bluemoon/sound/misc/catcrin_halt1.ogg', 100, 1)
			if(2)
				playsound(src.loc, 'modular_bluemoon/sound/misc/catcrin_halt2.ogg', 100, 1)
			if(3)
				playsound(src.loc, 'modular_bluemoon/sound/misc/catcrin_halt3.ogg', 100, 1)
...
/obj/item/banner/catcrin
	...
	icon = 'modular_bluemoon/icons/mob/icons/accessories.dmi'
...
/obj/structure/sign/flag/catcrin
	...
	icon = 'modular_bluemoon/icons/mob/icons/accessories_32x48.dmi'
	icon_state = "flag_catcrin"
	pixel_y = -12
