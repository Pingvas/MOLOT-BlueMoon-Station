/obj/item/magicwand
	...
	icon = 'modular_bluemoon/icons/items/lewd_items.dmi'
	mob_overlay_icon = 'modular_bluemoon/icons/items/onmob/toys.dmi'
	lefthand_file = 'modular_bluemoon/icons/items/onmob/lefthand.dmi'
	righthand_file = 'modular_bluemoon/icons/items/onmob/righthand.dmi'
...
/obj/item/magicwand/attack_self(mob/user)
	...
	update_icon()
	playsound(src.loc, 'modular_bluemoon/sound/effect/lewd/toys/magicwand1.ogg', 25, 1)
...
/obj/item/magicwand/attack(mob/living/carbon/human/M, mob/living/carbon/human/user)
	...
	if(message)
		...
		switch(mode)
			if(1)
				playsound(loc, pick('modular_bluemoon/sound/effect/lewd/toys/devicevibrator1.ogg',
								'modular_bluemoon/sound/effect/lewd/toys/devicevibrator2.ogg',
								'modular_bluemoon/sound/effect/lewd/toys/devicevibrator3.ogg'), 25, 1)
			if(2)
				playsound(loc, pick('modular_bluemoon/sound/effect/lewd/toys/magicwand1.ogg',
								'modular_bluemoon/sound/effect/lewd/toys/magicwand2.ogg'), 25, 1)
			if(3)
				playsound(loc, pick('modular_bluemoon/sound/effect/lewd/toys/magicwand3.ogg'), 25, 1)
...
/obj/item/magicwand/blackwand
	...
	icon = 'modular_bluemoon/icons/items/lewd_items.dmi'
	mob_overlay_icon = 'modular_bluemoon/icons/clothing/worn/back.dmi'
	lefthand_file = 'modular_bluemoon/icons/items/onmob/lefthand.dmi'
	righthand_file = 'modular_bluemoon/icons/items/onmob/righthand.dmi'
