...
/obj/item/gun/ballistic/shotgun/KS23
	...
	icon = 'modular_bluemoon/icons/items/weapons/ranged.dmi'
	...
	fire_sound = "modular_bluemoon/sound/weapons/fire_shotgun.ogg"
	icon_state = "KS-23"
	item_state = "KS-23"
	fire_delay = 7
...
/obj/item/gun/ballistic/shotgun/KS23/pump_unload(mob/M)
	if(chambered)//We have a shell in the chamber
		...
		chambered = null
		playsound(src, "modular_bluemoon/sound/weapons/shell_fall.ogg", 45, 1)
