...
/obj/structure/bed/dildo_machine/New()
	..()
	add_overlay(mutable_appearance('modular_bluemoon/icons/obj/lewd_devices.dmi', "dilmachine_over", MOB_LAYER + 1))
...
/obj/structure/bed/dildo_machine/proc/fuck()
	...
	for(var/mob/living/carbon/human/M in buckled_mobs)
		...
		playsound(loc, "modular_bluemoon/sound/effect/lewd/interactions/bang[rand(1, 6)].ogg", 30, 1)
