GLOBAL_LIST_INIT(modern_strings, list())
...
/proc/init_modern_strings()
	...
	"pda_theme"              = list("ru" = "Тема PDA",                             "en" = "PDA Theme"),
	"set_pda_theme"          = list("ru" = "Установить тему PDA",                "en" = "Set PDA theme"),
	...
	"marking_group_body"     = list("ru" = "Тело",                              "en" = "Body"),
	"marking_group_arms"     = list("ru" = "Руки",                              "en" = "Arms"),
	"marking_group_legs"     = list("ru" = "Ноги",                              "en" = "Legs"),
