...
/obj/item/organ/nucleation
	...
	icon = 'modular_bluemoon/code/modules/mobs/carbon/nucleation/icons/surgery.dmi'
...
/datum/species/nucleation
	...
	mutant_bodyparts = list("mcolor" = "F8F8F8", "mcolor2" = "F8F8F8", "mcolor3" = "F8F8F8", "mam_snouts" = "None",  "mam_tail" = "None", "deco_wings" = "None",
						"horns" = "None")
	override_bp_icon = 'modular_bluemoon/code/modules/mobs/carbon/nucleation/icons/r_nucleation.dmi'
...
/datum/sprite_accessory/hair/nucleation // ТОП 7 НЕФАРСКИХ СТРИЖЕК ЧТОБ ТЕБЯ ОТПИЗДИЛИ В ПОДВОРОТНЯХ.
	...
	icon = 'modular_bluemoon/code/modules/mobs/carbon/nucleation/icons/nucleation_face.dmi'
