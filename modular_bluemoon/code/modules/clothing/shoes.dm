/obj/item/clothing/shoes/polyflats
	...
	desc = "Flats."
	icon = 'modular_bluemoon/icons/clothing/object/shoes.dmi'
	mob_overlay_icon = 'modular_bluemoon/icons/clothing/worn/feet.dmi'
	anthro_mob_worn_overlay = 'modular_bluemoon/icons/clothing/worn/feet_digi.dmi'
