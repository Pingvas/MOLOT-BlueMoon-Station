/obj/item/clothing/wrists/armwarmer/transparent
	name = "Transparent Arm Warmers"
	desc = "A pair of transparent arm warmers."
	icon = 'modular_bluemoon/icons/clothing/object/wrists.dmi'
	mob_overlay_icon = 'modular_bluemoon/icons/clothing/worn/wrists.dmi'
	icon_state = "armwarmer_transparent"
	item_state = "armwarmer_transparent"
	body_parts_covered = ARMS

/obj/item/clothing/wrists/armwarmer/transparent_long
