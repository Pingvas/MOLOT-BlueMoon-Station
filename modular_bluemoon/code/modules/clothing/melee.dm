...
/obj/item/kitchen/knife/combat/kukri
	...
	item_state = "kukri"
	icon_state = "kukri"
	icon = 'modular_bluemoon/icons/obj/melee.dmi'
	lefthand_file = 'modular_bluemoon/icons/mob/inhands/melee_lefthand.dmi'
	righthand_file = 'modular_bluemoon/icons/mob/inhands/melee_righthand.dmi'
	unique_reskin = list(
		"Black" = list(
...
/obj/item/melee/classic_baton/telescopic/portal_abomination
	...
	icon = 'modular_bluemoon/icons/obj/UngodlyAbomination.dmi'
	...
	hitsound = 'modular_bluemoon/sound/weapon/Abomination.ogg'
