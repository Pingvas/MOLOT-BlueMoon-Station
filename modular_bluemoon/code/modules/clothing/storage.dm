/obj/item/storage/box/donator/bm/case_ds
	...
	var/opened = FALSE
	item_state = "ds-case"
	lefthand_file = 'modular_bluemoon/icons/mob/inhands/storage_lefthand.dmi'
	righthand_file = 'modular_bluemoon/icons/mob/inhands/storage_righthand.dmi'
	drop_sound = 'modular_bluemoon/sound/case_drop.ogg'
	pickup_sound =  'modular_bluemoon/sound/case_pickup.ogg'
	foldable = FALSE
	illustration = null
...
/obj/item/storage/backpack/satchel/hahun_bag
	...
	icon = 'modular_bluemoon/icons/obj/storage.dmi'
	mob_overlay_icon = 'modular_bluemoon/icons/mob/clothing/storage.dmi'
	lefthand_file = 'modular_bluemoon/icons/mob/inhands/storage_lefthand.dmi'
	righthand_file = 'modular_bluemoon/icons/mob/inhands/storage_righthand.dmi'
