...
// 	playsound(caster, 'modular_bluemoon/sound/effect/lewd/interactions/splat.ogg', 50, 0)
...
// 		playsound(caster, 'modular_bluemoon/sound/effect/lewd/interactions/bang6.ogg', 50, 1)
