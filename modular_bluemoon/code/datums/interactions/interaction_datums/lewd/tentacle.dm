...
/datum/interaction/lewd/tentacle/female/display_interaction(mob/living/user, mob/living/partner)
	...
	playlewdinteractionsound(get_turf(user), pick('modular_bluemoon/sound/effect/lewd/interactions/bang1.ogg',
						'modular_bluemoon/sound/effect/lewd/interactions/bang2.ogg',
						'modular_bluemoon/sound/effect/lewd/interactions/bang3.ogg',
						'modular_bluemoon/sound/effect/lewd/interactions/bang4.ogg',
						'modular_bluemoon/sound/effect/lewd/interactions/bang5.ogg',
						'modular_bluemoon/sound/effect/lewd/interactions/bang6.ogg'), 70, 1, -1)
