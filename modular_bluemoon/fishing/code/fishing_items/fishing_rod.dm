...
/obj/item/fishing_rod
	...
	icon = 'modular_bluemoon/fishing/icons/fishing.dmi'
	icon_state = "rod"
	lefthand_file = 'modular_bluemoon/fishing/icons/64x64_lefthand.dmi'
	righthand_file = 'modular_bluemoon/fishing/icons/64x64_righthand.dmi'
