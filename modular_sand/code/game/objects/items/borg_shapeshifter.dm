		...
		switch(module_selection)
			...
			if("Medical")
				var/static/list/med_icons = list(
					...
					"Fembot" = image(icon = 'modular_bluemoon/icons/mob/robots.dmi', icon_state = "fembot-medic"), //Gardelin0 Addon
					"Meka" = image(icon = 'modular_bluemoon/icons/mob/tallrobot.dmi', icon_state = "mekamed") //Krashly Request
				)
				...
				switch(borg_icon)
					...
					if("Fembot") // //Gardelin0 Addon
						...
						disguise_icon_override = 'modular_bluemoon/icons/mob/robots.dmi'
					if("Meka") //Krashly Request
						disguise = "mekamed"
						disguise_icon_override = 'modular_bluemoon/icons/mob/tallrobot.dmi'
					else
						return FALSE
			...
			if("Engineer")
				var/static/list/engi_icons = list(
					...
					"Fembot" = image(icon = 'modular_bluemoon/icons/mob/robots.dmi', icon_state = "fembot-engineering"), //Gardelin0 Addon
					"Meka" = image(icon = 'modular_bluemoon/icons/mob/tallrobot.dmi', icon_state = "mekaengi") //Krashly Request
				)
			...
			if("Security")
				var/static/list/sec_icons = list(
					...
					"Fembot" = image(icon = 'modular_bluemoon/icons/mob/robots.dmi', icon_state = "fembot-security") //Gardelin0 Addon
				)
			...
			if("Service")
				var/static/list/service_icons = list(
					...
					"(Service) Fembot" = image(icon = 'modular_bluemoon/icons/mob/robots.dmi', icon_state = "fembot-service"), //Gardelin0 Addon
					"(Service) Meka" = image(icon = 'modular_bluemoon/icons/mob/tallrobot.dmi', icon_state = "mekaserve"), //Krashly Request
					...
					"(Janitor) Fembot" = image(icon = 'modular_bluemoon/icons/mob/robots.dmi', icon_state = "fembot-janitor"), //Gardelin0 Addon
					"(Janitor) Ratge" = image(icon = 'modular_bluemoon/icons/mob/ratge.dmi', icon_state = "ratge"), //CassiusRogue Request
					"(Janitor) Meka" = image(icon = 'modular_bluemoon/icons/mob/tallrobot.dmi', icon_state = "mekajani") //Krashly Request
				)
				...
				switch(borg_icon)
					...
					if("(Janitor) Ratge") // //CassiusRogue request
						disguise = "ratge"
						disguise_icon_override = 'modular_bluemoon/icons/mob/ratge.dmi'
			...
			if("Miner")
				var/static/list/mining_icons = list(
					...
					"Fembot" = image(icon = 'modular_bluemoon/icons/mob/robots.dmi', icon_state = "fembot-miner"), //Gardelin0 Addon
					"Meka" = image(icon = 'modular_bluemoon/icons/mob/tallrobot.dmi', icon_state = "mekamine") //Krashly Request
				)
			...
			if("Peacekeeper")
				var/static/list/peace_icons = sort_list(list(
					...
					"Fembot" = image(icon = 'modular_bluemoon/icons/mob/robots.dmi', icon_state = "fembot-peace"), //Gardelin0 Addon
					"Meka" = image(icon = 'modular_bluemoon/icons/mob/tallrobot.dmi', icon_state = "mekacargo") //Krashly Request
				))
			...
			if("Syndicate")
				var/static/list/syndicatejack_icons = sort_list(list(
					...
					"Meka Syndie" = image(icon = 'modular_bluemoon/icons/mob/tallrobot.dmi', icon_state = "mekasyndi"), //Krashly Request
					"Meka Ninja" = image(icon = 'modular_bluemoon/icons/mob/tallrobot.dmi', icon_state = "mekaninja") //Krashly Request
				))
