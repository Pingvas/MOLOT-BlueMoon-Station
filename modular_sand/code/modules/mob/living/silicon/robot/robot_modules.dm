...
/obj/item/robot_module/syndicatejack/be_transformed_to(obj/item/robot_module/old_module)
	...
	var/static/list/syndicatejack_icons = sort_list(list(
		...
		"FMeka Ninja" = image(icon = 'modular_bluemoon/icons/mob/tallrobot.dmi', icon_state = "fmekaninja"), // Lyoll Request (Skyrat Port)
		"K4 Ninja" = image(icon = 'modular_bluemoon/icons/mob/tallrobot.dmi', icon_state = "k4tninja"), // Lyoll Request (Skyrat Port)
		"MMeka Ninja" = image(icon = 'modular_bluemoon/icons/mob/tallrobot.dmi', icon_state = "mmekaninja"), // Lyoll Request (Skyrat Port)
